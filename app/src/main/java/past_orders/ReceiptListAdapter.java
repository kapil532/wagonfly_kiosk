...
public class ReceiptListAdapter extends BaseAdapter {
    ArrayList<PastOrderPojoNew.itemsPojo> arraylist;
    Activity activity;
    LayoutInflater inflater;
    ImageLoader imageLoader;
    private DisplayImageOptions options;

    public ReceiptListAdapter(Activity activity, ArrayList<PastOrderPojoNew.itemsPojo> arraylist) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup)
    {
        ...
        TextView artist = (TextView)vi.findViewById(R.id.quantity); // artist name
      ...
      artist.setText(arraylist.get(position).getQuantity());
        double ii = (double)(Integer.parseInt(arraylist.get(position).getQuantity()) * Double.parseDouble(arraylist.get(position).getRetail_price()));
